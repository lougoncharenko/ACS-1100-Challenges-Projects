...
print("Please enter numberic values for the height, width and length when prompted")

height = input("Please enter a value for height:")
...
print(f"Your calculated area is {volume} cubic inches")
